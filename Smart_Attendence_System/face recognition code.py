...
image = CurrentFolder+'\\oybek.png'
image2 = CurrentFolder+'\\khusniya.png'
            ...
            if process_this_frame:
                ...
                for face_encoding in face_encodings:
                    ...
                    if((already_attendence_taken != name) and (name != "Unknown")):
                     ...
                     col =col+1
                     sheet1.write(row, col, "Keldi" )
                     row = row+1
                     col = 0
                     print(name+" bazaga qo'shildi")
                     wb.save('attendance_excel.xls')
                     already_attendence_taken = name
                    else:
                        if (already_attendence_taken == name):
                            engine = pyttsx3.init()
                            engine.say("Следующий студент")
                            engine.runAndWait()
